...
public class GrafoDirigido<T> implements Grafo<T> {
    ...
    public Iterator<Integer> obtenerAdyacentes(int verticeId) {
        ...
        if (vertices.containsKey(verticeId)) {// todos los vertices q contengan la clave
    ...
    public void dfs(Grafo<T> grafo) {
        for (GrafoDirigido  v : vertices){

        }
    }
    public boolean tieneCilclo(Grafo<T> grafo) {
        CiclodeVida<T>
        if (!dfs.dfs(grafo).isEmpty()){
